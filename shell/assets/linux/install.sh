...
wget https://github.com/upgradeadvice/copay/releases/download/v0.1.1/Copay-linux-x64.tar.gz
# extract archive
...
wget https://raw.githubusercontent.com/upgradeadvice/copay/master/shell/assets/linux/Copay.desktop
